...
// Remove static export configuration for API routes
        ...
        if (uploadError) {
          ...
          try {
            ...
            if (testResponse.ok) {
              ...
              console.warn('⚠️ Receipt URL may not be accessible:', testResponse.status)
            }
          } catch (testError) {
...
// Function to send notification emails using the email service
